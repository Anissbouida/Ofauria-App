...
export const ordersApi = {
  ...
  create: (data: Record<string, any>) => api.post('/orders', data).then(r => r.data.data),
  update: (id: string, data: Record<string, any>) => api.put(`/orders/${id}`, data).then(r => r.data.data),
