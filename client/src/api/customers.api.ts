...
export const customersApi = {
  ...
  create: (data: Record<string, any>) => api.post('/customers', data).then(r => r.data.data),
  update: (id: string, data: Record<string, any>) => api.put(`/customers/${id}`, data).then(r => r.data.data),
