...
export const purchaseOrdersApi = {
  ...
  confirmDelivery: (id: string, data: { items: { itemId: string; quantityDelivered: number; unitPrice?: number | null; supplierLotNumber?: string; expirationDate?: string; manufacturedDate?: string }[]; supplierInvoiceNumber?: string; supplierInvoiceDate?: string }) =>
