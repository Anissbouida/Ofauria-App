...
export default function AppLayout() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-100">
      ...
      <main className={`flex-1 overflow-auto ${(location.pathname.startsWith('/inventory') || location.pathname.startsWith('/recipes') || location.pathname.startsWith('/products')) ? '' : 'p-6'}`}>
        <Outlet />
      </main>
