...
const modules: { name: string; href: string; icon: typeof LayoutDashboard; color: string; module: AppModule }[] = [
  ...
  { name: 'Pre-commandes', href: '/orders', icon: ClipboardList, color: 'bg-orange-500', module: 'orders' },
  ...
  { name: 'Personnel', href: '/employees', icon: UserCog, color: 'bg-teal-600', module: 'employees' },
