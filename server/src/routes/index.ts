...
import employeesRoutes, { schedulesRouter, attendanceRouter, leavesRouter, payrollRouter, shiftsRouter, weeklyPayrollRouter, salaryAdvancesRouter } from './employees.routes.js';
