...
import { createReturnSchema } from '../validators/return.validator.js';
...
router.post('/', authenticate, authorize(...ROLE_GROUPS.SALES), validate(createReturnSchema), returnController.create);
